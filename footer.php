            ...
            <form name="upload" id="imageform" action='ajaximage.php' method="post" enctype="multipart/form-data">
                <div class="photo-job-video">
                    ...
                    <div class="row" style="margin-bottom: 0px;">
                        <?php if ($loginid == "") { ?>
                            <div class="col-3 uploader"><a style="font-size:20px" data-fancybox data-type="inline" data-src="#loginPopup" href="javascript:void(0);" class="border_post">photo</a></div>
                                <div class="col-2"><a style="font-size:20px" data-fancybox data-type="inline" data-src="#loginPopup" href="javascript:void(0);" class="border_post">job</a></div>
                                <div class="col-3 uploader"><a style="font-size:20px" href="javascript:void(0);" data-fancybox data-type="inline" data-src="#loginPopup" class="border_post">Video</a></div>
                                <div class="col-4 uploader"><a style="font-size:20px" href="javascript:void(0);" data-fancybox data-type="inline" data-src="#loginPopup">Question</a></div>
                                <?php
                            } else {
                                $notcomplete = 0;
