...
<html>
    ...
    <body>
        <style>
			...
			.left-select.bgnone.country-dropdown {
				width: 45%;
			
			}
	#selectcountry, .filter-link {
...
.select-box.select-style {
	margin-top: 0;
}
.left-select .select-style {
	background: none;
...
#selectcountry, .filter-link {
	...
	line-height:24px
            ...
            <?php if ($incomplete_profile && basename($_SERVER["SCRIPT_FILENAME"], '.php') != 'make-profile') { ?>
                .main {
                    margin-top: 21px;
                }
            <?php }
        ...
        <div class="wrapper">
            ...
            <div class="main-wrapper-banner">
                <div class="container clearfix top-bar-border"></div>
                <div class="container clearfix">
                    <div class="sub-header">
                        <div class="left-select bgnone country-dropdown">
